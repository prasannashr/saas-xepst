angular.module('app').controller('mvNavBarLoginCtrl', function($scope, $http, mvIdentity, mvAuth, $location, $translate, Notification, $rootScope, $filter) {
    ...
    if($scope.identity.isAuthenticated()) {
        ...
        $http.get("/api/getLanguageOptions/").success(function(data) {
            ...
            $http.get("jsons/countriesList.json").success(function(response) {
